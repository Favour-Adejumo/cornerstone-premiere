...
export function Navbar() {
  ...
  return (
    <header
      className={cn(
        "fixed inset-x-0 top-0 z-50 border-b bg-background/95 backdrop-blur-sm transition-shadow duration-300",
        scrolled || open ? "border-border shadow-sm" : "border-border/70",
      )}
    >
      <nav
        aria-label="Main"
      ...
      >
        ...
        >
          ...
          />
          <span className="flex min-w-0 flex-col leading-none text-foreground">
